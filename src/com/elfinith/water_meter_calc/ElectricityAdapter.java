...
public class ElectricityAdapter extends ArrayAdapter<String> {
    ...
    public ElectricityAdapter(Context context, int resource, int textViewResourceId, List<String> objects, int AvgVal) {   	
